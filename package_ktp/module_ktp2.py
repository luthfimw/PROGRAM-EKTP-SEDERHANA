        ...
        while True: #while true utama, PENTING UNTUK AKHIR 
                ...
                while True:
                        ...
                        if ulang in ["iya","IYA","Iya","ya","YA","Ya"]: #jika memilih 'iya' , maka data akan disimpan dalam list, jika kemudian ingin menambahkan data lagi, dia bisa menyimpan data baru tersebut di dalam nesting list.
                                ...
                                print('\nJika data belum sesuai, silakan masukkan data ktp lagi dengan mengketik "iya" pada pilihan berikutnya...\n')
                                break
                        else:
                ...
                while True:                
                        ...
                        if pilihan_loop_utama in ["iya","IYA","Iya","ya","YA","Ya"]:
                                break #break ini hanya dummy
                        else:
                                print('Mohon ketikkan "iya" atau "tidak"...\n')
                if pilihan_loop_utama in ["tidak","Tidak","TIDAK","TDK","tdk","Tdk"]: 
                        break
                ...
                while True:
                        try:                               
                                ...
                                if list_KTP[kartu_nomor-1] == None:
                                        print(f'\nData E-KTP anda pada nomor {kartu_nomor} telah dihapus...')
                                        continue
                                ...
                                #KODE DI BAWAH INI UNTUK MENAMPILKAN DI NOTEPAD
                                        ...
                                        while True:
                                                ulang = str(input("Apakah anda ingin mencetak nomor kartu lainnya? Ketik 'iya' atau 'tidak' \n"))
...
def hapus_data(list_KTP:list,no_kartu_user:list)->list: 
        while True:   
                if len(no_kartu_user) == 0:
                        print('')
                        print('='*46)
                        print('Seluruh nomor data E-KTP anda sudah dihapus...')
                        print('Silakan masukkan ulang pada pilihan pertama...')
                        print('='*46) 
                        print('') 
                        break
                else:
                        break  
        while len(no_kartu_user)!=0:
